...
def iri_to_web_url(iri: str, language: str = "en") -> str:
    ...
    Example:
        ...
        'https://vocab.sentier.dev/web/concept/https%3A//vocab.sentier.dev/Geonames/A?concept_scheme=https%3A%2F%2Fvocab.sentier.dev%2FGeonames&language=en'
    """
    ...
    if len(parts) >= 5 and parts[2] == "vocab.sentier.dev":
        # Scheme is base_url + namespace (first path segment) without trailing slash
