...
async def test_get_concept_returns_definition():
    ...
    mock_concept_data = {
        ...
        "http://www.w3.org/2004/02/skos/core#definition": [
            {
                "@language": "en",
                "@value": "Includes all sorts of live animals, including things you probably never heard of before."
            }
        ]
    }
    ...
    with patch('httpx.AsyncClient') as mock_client_class:
        ...
        result = await client.get_concept("http://data.europa.eu/xsp/cn2024/010021000090")
        ...
        assert "/concepts/http://data.europa.eu/xsp/cn2024/010021000090" in call_args[0][0]
...
def test_fetch_concept_async_extracts_english_definition():
    ...
    with patch.object(get_suggest_client(), 'get_concept', new_callable=AsyncMock) as mock_get:
...
def test_fetch_concept_async_falls_back_to_first_definition():
    """Test that fetch_concept_async falls back to first definition if language not found."""
    import asyncio
    from trailpack.ui.streamlit_app import fetch_concept_async
    from trailpack.pyst.api.client import get_suggest_client
